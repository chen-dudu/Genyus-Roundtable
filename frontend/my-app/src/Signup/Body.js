...
class Body extends React.Component {
  constructor(props) {
    ...
    console.log(this.onPasswordEnter);
  ...
  signup(e) {
    ...
    // first sign up user
    au.createUserWithEmailAndPassword(this.state.email, this.state.password).then(credential => {
      ...
      <BodyWrapper>
        ...
        <form onSubmit={this.signup}>
          ...
          <div align={'center'} style={{ width: '90%' }}>
            <input align={'center'} id={'signup-button'} style={{
              background: "#3399ff", borderRadius: 5,
