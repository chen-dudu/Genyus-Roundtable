...
class Body1 extends React.Component {
	...
	render() {
		...
		return (
			<Body1Wrapper>
				<h1>Home</h1>
				<Button  type="primary" style={{ margin: '8% 55% 0', width: '15%', height: '10%', position: 'absolute' }} onClick={() => this.props.history.push('/Participant/ParticipantPodList')}>My Schedule</Button>
				<ProfileWrapper>
